...
\begin{itemize}
	...
	\item \pyth{@classmethod get_rotation_matrix(cls, r, p, A)} | Returns the rotation matrix of the body w.r.t. the LLF as a NumPy ndarray given roll, pitch, and azimuth in radians.
